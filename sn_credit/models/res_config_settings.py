...
class CreditsSettings(models.TransientModel):
    ...
    let_duplicate_client_ccp = fields.Char(string='Numeno ccp', default='')
    ...
    def get_values(self):
        ...
        res['let_duplicate_client_ccp'] = self.env['ir.config_parameter'].with_user(True).get_param('sn_credit.let_duplicate_client_ccp', default='')
        return res
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].with_user(True).set_param('sn_credit.let_duplicate_client_ccp', self.let_duplicate_client_ccp)
