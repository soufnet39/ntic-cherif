odoo.define('op_homepage.homepage', function (require) {
"use strict";
...
var HrHomepageView = AbstractAction.extend(ControlPanelMixin, {
	...
	init: function(parent, context) {
        ...
        var employee_data = [];
        var self = this;
        if (context.tag == 'op_homepage.homepage') {
            self._rpc({
    ...
    render: function() {
        ...
        var self = this;
        var hr_homepage = QWeb.render( 'op_homepage.homepage', {
            widget: self,
        });
...
core.action_registry.add('op_homepage.homepage', HrHomepageView);
