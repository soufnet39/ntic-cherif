odoo.define('sn_homepage.BoardView', function (require) {
"use strict";
...
var SnhomepageController = FormController.extend({
...
var SnhomepageRenderer = FormRenderer.extend({
    ...
    getBoard: function () {
        ...
        this.$('.oe_dashboard_column').each(function () {
            ...
            sn_homepage.columns.push(actions);
        });
        return board;
    },
...
var BoardView = FormView.extend({
    config: _.extend({}, FormView.prototype.config, {
        Controller: SnhomepageController,
        Renderer: SnhomepageRenderer,
    }),
...
odoo.define('sn_homepage.viewRegistry', function (require) {
"use strict";

var BoardView = require('sn_homepage.BoardView');
