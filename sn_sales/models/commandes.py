...
class NticSaleCommande(models.Model):
    ...
    @api.depends('commande_lines.price_total', 'tva_exist', 'tva_taux', 'remise_exist','remise_applied_on', 'remise_methode','remise_taux','remise_mta')
    def _amount_all(self):
        for commande in self:
                ...
                if line.display_type not in ['line_section','line_note']:
                    ...
                    if commande.remise_exist and commande.remise_applied_on=='article':
                        if commande.remise_methode == 'taux':
                            ...
                            remise_valeur += round(line.price_total*line.remise_taux/100,2)
            ...
            if commande.remise_exist and commande.remise_applied_on == 'global':
                if commande.remise_methode == 'taux':
                    remise_valeur = round(amount_ht * commande.remise_taux/100,2)
